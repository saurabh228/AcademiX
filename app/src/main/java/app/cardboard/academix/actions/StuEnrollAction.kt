...
fun SetStudent() {
    ...
    Column(
        ...
        Button(
            onClick = {
                kbController?.hide()
                val query = "INSERT INTO Student (LastName, FirstName, DateOfBirth, Email, PhoneNumber) VALUES ('${lastName.trim()}', '${firstName.trim()}', '${dob.trim()}', '${email.trim()}', '${phone.trim()}')"
                val studentName = "${firstName.trim()} ${lastName.trim()}"
                lastName = ""
                firstName = ""
                dob = ""
                email = ""
                    ...
                    onClick = {
                        ...
                        if (studentID != null) {
                            ...
                            GlobalScope.launch(Dispatchers.IO) {
                                ...
                                if (connection != null) {
                                    students =
                                        databaseTask.getStu(studentID, connection)
                                    connection.close()
